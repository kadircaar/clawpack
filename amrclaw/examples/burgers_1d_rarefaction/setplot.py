...
#--------------------------
    ...
    plotaxes.xlimits = [-.2,1.2]
    plotaxes.ylimits = [-.4,1.5]
    ...
    plotitem.amr_kwargs = [{'markersize':5},{'markersize':5},{'markersize':4}]

    def addtrue(current_data):
        from pylab import plot, legend
        x = linspace(0,1,1000)
        t = current_data.t
        plot([-0.2, 0, t,1.2], [0, 0, 1, 1],color='steelblue',label='true solution')
    def plot_addtrue_with_legend(current_data):
        ...
        try:
            ...
            legend_tools.add_legend(labels, colors=['g','b','r','steelblue'],
