...
#--------------------------
    ...
    plotitem.plot_var = 0
    plotitem.amr_color = ['g','b','k']
    plotitem.amr_plotstyle = ['^-','s-','o-']
    plotitem.amr_data_show = [1,1,1]
    plotitem.amr_kwargs = [{'markersize':6},{'markersize':6},{'markersize':6}]
    ...
    def plot_qtrue_with_legend(current_data):
        ...
        try:
            ...
            legend_tools.add_legend(labels, colors=['g','b','k','r'],
