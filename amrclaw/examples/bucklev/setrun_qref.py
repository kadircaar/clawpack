...
#------------------------------
    ...
    probdata.add_param('ul',     1.0,  'u right')
    probdata.add_param('ur',     0.0,  'u lefr')
    ...
    clawdata.lower[0] = -0.2000000          # xlower
    clawdata.upper[0] = 1.500000         # xupper
    ...
    if clawdata.output_style==1:
        ...
        clawdata.tfinal = 1.00000000
        clawdata.output_t0 = True  # output at initial (or restart) time?
        
    elif clawdata.output_style == 2:
        # Specify a list or numpy array of output times:
        # Include t0 if you want output at the initial time.
        clawdata.output_times =  [0.1, 0.15]
 
    elif clawdata.out.iput_style == 3:
    ...
    clawdata.dt_max = 1.000000
    
    # Desired Courant number if variable dt used 
    clawdata.cfl_desired = 0.9
    # max Courant number to allow without retaking step with a smaller dt:
    clawdata.cfl_max = 1.00000
