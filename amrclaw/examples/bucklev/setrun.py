...
#------------------------------
    ...
    probdata.add_param('ul',     1.0,  'u lefy = speed limit')
    probdata.add_param('ur',     0.0,  'u right = initial uniform density')
    probdata.add_param('a' ,      0.5,  'parameter in the flux function')
    #------------------------------------------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.tfinal = 1.0000000
        clawdata.output_t0 = True  # output at initial (or restart) time?
        
    elif clawdata.output_style == 2:
        # Specify a list or numpy array of output times:
        # Include t0 if you want output at the initial time.
        clawdata.output_times =  [0.0, 1.0]
    ...
    amrdata.flag_richardson_tol = 0.1e+00  # Richardson tolerance
